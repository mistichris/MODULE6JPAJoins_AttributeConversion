...
public class BookListItemsHelper {
	static EntityManagerFactory emfactory = Persistence.createEntityManagerFactory("WebBooksJPAJoinsAttributeConv2");		//creating a global instance of the Entity Manager Factory
